...
struct Interface
{
    ...
    Fl_Button*          BoutonVador; //Declaration des Objets : Vador correspond à la résolution de la grille
    Fl_Button*          BoutonRecommencer;
...
extern struct Interface gInterface ;
 ...
 struct Carre //Structure Carre necessaire dans la fonction trouver carre
    {
        int Prems;
        int Cases[8];
    };
