/*
===============================================================
Ce fichier stdrusty.h a du être télécharger sur internet et lié
au projet, il s'aggit du fichier .h de Rusty Rossel necessaire
pour la résolution de la grille de Sudoku
===============================================================
*/
